...
include::partial$methodik/image-perception-action-coupling.adoc[]
...
, oder klassischen Lehrbüchern, z. B.
include::partial$gen/bibliography.adoc[tags=barth_fechttraining_2005]
, wird suggeriert, es gäbe eine ideale Form der Technik. Abweichungen werden als „Fehler“ markiert und korrigiert.

Doch diese Sichtweise ignoriert die Individualität des Menschen: Körper und Geist sind steter Veränderung unterworfen, und jedes Individuum bringt eigene Voraussetzungen mit
include::partial$gen/bibliography.adoc[tags=kimmerle_jacques_2000]
. In der klassischen Methodik fällt das Besondere jedes Einzelnen durch das Raster
...
Wenn wir heute ein altes Lehrbuch aufschlagen, findet sich für den Fußtreffer eine hochkomplexe Choreografie: Die gegnerische Spitze muss erst mühsam beseitigt oder gebunden werden, der Angriff muss chirurgisch vorbereitet sein, und nach dem Treffer muss sofort eine Absicherung erfolgen, um den Gegentreffer zu verhindern.
...
* Bewegungslösungen sind die Antworten des Athleten auf die Realität der Bahn (Ausrüstung, Scoring-System, moderne Klingen). Die Athleten finden und steuern sie.
...
include::partial$methodik/image-bernsteins-fencer.adoc[]
...
_Beispiel: Beim Schritt nach vorne geben wir nicht vor, ob nun Ferse oder Zehen zuerst den Boden verlassen. Statt dessen variieren wir den Boden, die Körperneigung oder stören mit Seilen und Bällen. Die Athletin wird sich je nach Situation anpassen._
...
== Unser System des Chaos - Fintenfisch und die Dynamic Systems Theory (DST)
...
include::partial$methodik/image-self-organized-fencer.adoc[]
...
include::partial$methodik/image-attractor-landscape.adoc[]
...
Wenn wir die DST ernst nehmen, müssen wir uns von einer der liebsten Aufgaben des Trainers verabschieden: der ständigen Korrektur. „Der Arm war zu tief“, „Der Ausfall war zu kurz“, „Arm vor Bein“.
...
Wenn wir unseren Schülern jahrelang beigebracht haben, wie eine Parade im klinisch reinen Umfeld der Lektion aussieht, dann haben wir sie auf ein Szenario vorbereitet, das in der Weltspitze niemals eintritt. Wir haben eine *„fragile“ Technik* gezüchtet.
...
* *Lineare Pädagigik & Kognitivismus*: +
...
* *Lernen durch Einsicht / Lernen durch Zuhören*: +
  Sie (liebe Coaches der alten Schule) reden gerne? Wir nicht. Während Sie erklären, trainieren unsere Athletinnen bereits die zwanzigste Quart-Parade-Variante. Wir wollen Action, keine Vorlesungen
...
* Der Athlet reagiert in der Lektion nicht nur auf die Instruktion des Trainers, sondern auch auf die unbeabsichtigte Variabilität (die Fehler!) des Trainers. Er lernt also _trotz des Drills_, weil der Trainer glücklicherweise darin versagt, perfekt zu sein.
...
*Eine engagierte 20-jährige Trainerassistentin mit einem tiefen Verständnis für den Constraints-Led Approach kann langfristig bessere, stabilere Fechter ausbilden als ein ehemaliger Olympiasieger, der klassisch lektioniert.*
...
include::partial$methodik/image-optimal-challenge-point.adoc[]
...
include::partial$methodik/image-newels-triangle.adoc[]
...
include::partial$methodik/image-classic-vs-differential.adoc[]
...
include::partial$methodik/image-poolnoodle-fencing.adoc[]
...
include::partial$methodik/image-ltad.adoc[]
