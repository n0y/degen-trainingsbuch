...
* Wirkungsweise der DST: (Mensch + Umwelt + Aufgabe) - was das im Fechten bedeutet - wie es angewendet wird.
* Selbstorganisation statt Programmierung: warum wir nicht mehr korrigieren - oder jedenfalls nicht verbal - was es ersetzt
* Perzeptions-Aktions-Kopplung: Warum wir Lösungen provozieren, statt sie vorzugeben
