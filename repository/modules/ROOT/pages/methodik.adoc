...
* Warum Taktik im Körper steckt, nicht nur im Kopf.
* Externer vs. Interner Fokus: Warum „Triff die Weste“ besser funktioniert als „Streck den Arm“.
* Die Sprache des Coachings: Weniger reden, mehr steuern (Implicit Learning).
