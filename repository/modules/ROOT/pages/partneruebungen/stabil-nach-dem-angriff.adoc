...
* *Akteur*: Greife explosiv an, touchiere die Grenze und federe sofort in einem fließenden Rhythmus zurück in die Ausgangslage, um direkt für den nächsten "Pass" bereit zu sein.
