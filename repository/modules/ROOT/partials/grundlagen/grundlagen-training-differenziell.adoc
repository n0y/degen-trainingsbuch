...
Bei der Auswahl geeigneter Lernverfahren für Training im Verein ist die Anwendbarkeit in größeren Gruppen. Dabei ist davon auszugehen, dass jeder Lernende ganz eigene, unterschiedliche Voraussetzungen mitbringt, die jeweils zu unterschiedlichen Leistungsoptima führen muß.
