...
, Kap 4.1, ergeben sich mehrere Möglichkeiten zur Anpassung, um die spezifischen Anforderungen im modernen Degenfechten angemessen zu erfüllen. Dabei ergeben sich für jede Anpassung jeweils Vorteile und Nachteile.
...
* Der Fußabstand wird in vielen Fällen deutlich vergrößert. Zweieinhalb bis drei Fußlängen sind hier keine Seltenheit. Dieser Abstand verbessert den Winkel, mit dem der hintere Fuß Kraft auf den Boden überträgt. In Abhängigkeit vom Reibungskoeffizient zwischen Schuhsohle und Metallbahn liegt der optimale Winkel bei etwa 42°. Das ist in normalen Stellungen nicht ganz zu erreichen, sodass hier meist gilt: je mehr, desto besser. +
 _Vorteile:_ Bessere Kraftübertragung in beide Richtungen, höhere Standfestigkeit, bessere Balance +
 _Nachteile_: schnellere Ermüdung, Halbschritte erschwert
* Speziell beim hinteren Fuß wird häufig die Ferse vom Boden gehoben. Bei großen Bodenwinkeln ist eine entspannte Haltung anders auch nicht möglich, weil das Ziel ist, die Wadenmuskeln im optimalen Arbeitsbereich zu halten. +
 _Vorteile:_ mehr Explosivität, einfachere Tempowechsel und taktische Täuschungen +
 _Nachteile:_ schnellere Ermüdung, Belastung Achillessehne & Wade (im Training zu beachten)
...
_Vorteile_: mehr Explosivität, Provokation verfrühter Aktionen, Verlängung der Reichweite +
_Nachteile_: schnellere Ermüdung, Schulter schwieriger zu decken
...
_Vorteile_: schnellerer Rückzug, psychologischer Druck +
_Nachteile_: Fuß schwerer zu verteidigen
...
_Vorteile_: bessere Balance, bessere Körperspannung, mehr taktische Flexibilität +
_Nachteile_: größere Trefffläche, höheres Verletzungsrisiko
...
_Vorteile_: mehr Stoßdynamik, dominantere Körpersprache +
_Nachteile_: größere Trefffläche, Handauslagen muss angepasst werden
* Der vordere Arm wird stärker angewinkelt, oft in einem Winkel von 90°. Da die explosive Armstreckung in unter 100ms erfolgt
include::partial$gen/bibliography.adoc[tags=abazari_kinematic_2016]
  und die Muskulatur in stärkerer Expansion höhere Kräfte erreicht, kommt auch aus dieser Position ein Treffer nahezu gleichzeitig auf. Es lässt sich dadurch ohne Nachteile eine höhere Manövrierfähigkeit erreichen und die Hand ist vor Angriffen besser geschützt. +
_Vorteile:_ Paraden näher am Körper, Arm besser zu verteidigen, einfachere Stoßtäuschungen +
_Nachteile:_ Spontane Angriffe schwieriger
...
_Vorteile:_ mehr Explosivität (durch Vorspannung), bessere Distanzkontrolle, strahlt Dominanz aus +
_Nachteile:_ schnellere Ermüdung,
