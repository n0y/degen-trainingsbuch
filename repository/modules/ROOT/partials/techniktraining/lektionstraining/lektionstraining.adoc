...
Gemäß der xref:page$grundlagen.adoc#grundlagen-umsetzungsprinzipien[] wird auch bei der Lektionsarbeit eine einzelne Übung (=Kombination aus Aktion und gewählter Variation) niemals wiederholt. Es geht immer mit der nächsten Kombination weiter.
